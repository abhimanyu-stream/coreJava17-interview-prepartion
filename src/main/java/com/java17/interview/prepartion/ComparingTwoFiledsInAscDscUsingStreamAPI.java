...
public class ComparingTwoFiledsInAscDscUsingStreamAPI {
    ...
    public static void main(String[] args) {
       ...
       Map<Precedence, List<GEmployee>> mapBasedPrecedenceAndListOfGEmployee = listOfGEmployee.stream().collect(Collectors.groupingBy(GEmployee::getPrecedence, Collectors.toList()));
       System.out.println(mapBasedPrecedenceAndListOfGEmployee);
